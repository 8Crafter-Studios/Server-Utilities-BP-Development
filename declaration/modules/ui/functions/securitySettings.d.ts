...
export declare function securitySettings_settingsSelection(sourceEntitya: Entity | executeCommandPlayerW | Player): Promise<0 | 1>;
export declare function securitySettings_playersWithPermissions(sourceEntitya: Entity | executeCommandPlayerW | Player): Promise<0 | 1>;
...
export declare function securitySettings_playersWithPermissions_UltraSecurityMode(sourceEntitya: Entity | executeCommandPlayerW | Player): Promise<0 | 1>;
