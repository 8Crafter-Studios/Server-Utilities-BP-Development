 ...
 */
export declare function fillHollowSphere<LiteModeEnabled extends boolean = false>(center: Vector3, radius: number, thickness: number, dimension: Dimension, block: (location: DimensionLocation, index: bigint) => BlockPermutation, options?: {
    blockMask: BlockMask;
