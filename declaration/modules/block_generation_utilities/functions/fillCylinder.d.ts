 ...
 */
export declare function fillCylinder<LiteModeEnabled extends boolean = false>(center: Vector3, radius: number, length: number, axis: "x" | "y" | "z", dimension: Dimension, block: (location: DimensionLocation, index: bigint) => BlockPermutation, options?: {
    blockMask: BlockMask;
