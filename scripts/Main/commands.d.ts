...
export declare function cmdsEvalAsync(x: string, eventData?: ChatSendBeforeEvent, bypassChatInputRequests?: boolean, runreturn?: boolean, returnBeforeChatSend?: boolean, returnBeforeChatCommandsOrChatSend?: boolean, event?: ChatSendBeforeEvent, player?: Player, sendToPlayers?: Player[], newMessage?: string, switchTest?: string, switchTestB?: string, commanda?: command<"built-in" | "custom" | "unknown"> | typeof commands[number] | {
    type: string;
}): Promise<any>;
