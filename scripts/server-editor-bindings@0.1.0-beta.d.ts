...
declare module "@minecraft/server-editor-bindings" {
    ...
    enum BlockMaskListType {
        Disabled = "Disabled",
        Mask = "Mask",
        Replace = "Replace"
    }
    enum BlockPaletteItemType {
        Simple = 0,
        Probability = 1
    }
    enum BrushDirectionalPlacementMode {
        IgnoreCamera = 0,
        NormalCamera = 1,
        OppositeCamera = 2,
        CameraLeft = 3,
    ...
    enum MouseActionCategory {
        Button = 1,
        Wheel = 2,
        Drag = 3
    }
    enum PaintCompletionState {
        Success = 0,
        Canceled = 1,
        Failed = 2
    }
    ...
    enum ProjectExportType {
        PlayableWorld = 0,
        ProjectBackup = 1,
        WorldTemplate = 2
    }
    enum SelectionVolumeEventType {
        Set = 1,
        Add = 2,
        Remove = 3,
        Translate = 4,
    ...
    enum WidgetGroupSelectionMode {
        Multiple = "Multiple",
        None = "None",
        Single = "Single"
    }
    enum WidgetMouseButtonActionType {
        Pressed = 0,
        Released = 1,
        Drag = 2
    }
    ...
    class BlockUtilities {
         ...
         * @throws This function can throw errors.
         */
        fillVolume(volume: minecraftserverbindings.BlockVolumeBase | minecraftserverbindings.CompoundBlockVolume | RelativeVolumeListBlockVolume, block?: minecraftserverbindings.BlockPermutation | minecraftserverbindings.BlockType | string): void;
        /**
         * @remarks This function can't be called in read-only mode.
         */
         ...
         * @remarks This function can't be called in read-only mode.
         */
        isLocationInsideCurrentDimensionBounds(locationOrVolumeOrBounds: minecraftserverbindings.BlockBoundingBox | minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume | minecraftserverbindings.Vector3): boolean;
        /**
         * @remarks This function can't be called in read-only mode.
         *
         * @throws This function can throw errors.
         ...
         * @throws This function can throw errors.
         */
        trimVolumeToFitContents(volume: minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume, retainMarqueeAfterTrimming: boolean, ignoreLiquid: boolean, ignoreNoCollision: boolean, blockMask?: BlockMaskList): RelativeVolumeListBlockVolume;
    }
    ...
    class ClipboardItem {
         ...
         * @throws This function can throw errors.
         */
        getPredictedWriteVolume(location: minecraftserverbindings.Vector3, options?: ClipboardWriteOptions): RelativeVolumeListBlockVolume;
        /**
         * @remarks This function can't be called in read-only mode.
         *
         * @throws This function can throw errors.
    ...
    class EditorStructure {
         ...
         * {@link minecraftserverbindings.InvalidStructureError}
         */
        setBlockPermutation(location: minecraftserverbindings.Vector3, blockPermutation: minecraftserverbindings.BlockPermutation, waterlogged?: boolean): void;
        /**
         * @remarks This function can't be called in read-only mode.
         *
         * @throws This function can throw errors.
    ...
    class ProbabilityBlockPaletteItem extends IBlockPaletteItem {
         ...
         * @throws This function can throw errors.
         */
        addBlock(block: minecraftserverbindings.BlockPermutation | minecraftserverbindings.BlockType | string, weight: number): void;
    ...
    class RelativeVolumeListBlockVolume extends minecraftserverbindings.BlockVolumeBase {
         ...
         * @remarks This function can't be called in read-only mode.
         */
        add(toAdd: minecraftserverbindings.Vector3[] | minecraftserverbindings.BlockVolume | minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume | minecraftserverbindings.Vector3): void;
        /**
         * @remarks This function can't be called in read-only mode.
         */
        clear(): void;
         ...
         * @remarks This function can't be called in read-only mode.
         */
        remove(toRemove: minecraftserverbindings.Vector3[] | minecraftserverbindings.BlockVolume | minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume | minecraftserverbindings.Vector3): void;
        /**
         * @remarks This function can't be called in read-only mode.
         */
        set(toSet: minecraftserverbindings.Vector3[] | minecraftserverbindings.BlockVolume | minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume | minecraftserverbindings.Vector3): void;
        /**
         * @remarks This function can't be called in read-only mode.
         */
    ...
    class SelectionContainerVolume extends SelectionContainerBase {
         ...
         * @remarks This function can't be called in read-only mode.
         */
        add(volume: minecraftserverbindings.Vector3[] | minecraftserverbindings.BlockVolume | minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume | minecraftserverbindings.Vector3): void;
        /**
         * @remarks This function can't be called in read-only mode.
         */
        clear(): void;
         ...
         * @remarks This function can't be called in read-only mode.
         */
        remove(volume: minecraftserverbindings.Vector3[] | minecraftserverbindings.BlockVolume | minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume | minecraftserverbindings.Vector3): void;
        /**
         * @remarks This function can't be called in read-only mode.
         */
        set(volume: minecraftserverbindings.Vector3[] | minecraftserverbindings.BlockVolume | minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume | minecraftserverbindings.Vector3): void;
        /**
         * @remarks This function can't be called in read-only mode.
         */
        translate(offset: minecraftserverbindings.Vector3): void;
    ...
    class Widget {
         ...
         * @throws This function can throw errors.
         */
        addBoundingBox(componentName: string, size: minecraftserverbindings.Vector3, options?: WidgetComponentBoundingBoxOptions): WidgetComponentBoundingBox;
        /**
         * @remarks This function can't be called in read-only mode.
         *
         * @throws This function can throw errors.
         ...
         * @throws This function can throw errors.
         */
        addVolumeOutline(componentName: string, volume?: minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume, options?: WidgetComponentVolumeOutlineOptions): WidgetComponentVolumeOutline;
        /**
         * @remarks This function can't be called in read-only mode.
         *
         * @throws This function can throw errors.
    ...
    class WidgetComponentRenderPrimitiveTypeBox extends WidgetComponentRenderPrimitiveTypeBase {
         ...
         */
        size?: minecraftserverbindings.Vector3;
        constructor(center: minecraftserverbindings.Vector3, color: minecraftserverbindings.RGBA, size?: minecraftserverbindings.Vector3);
    }
    ...
    class WidgetComponentRenderPrimitiveTypeLine extends WidgetComponentRenderPrimitiveTypeBase {
        ...
        constructor(start: minecraftserverbindings.Vector3, end: minecraftserverbindings.Vector3, color: minecraftserverbindings.RGBA);
    }
    ...
    class WidgetComponentVolumeOutline extends WidgetComponentBase {
         ...
         * {@link InvalidWidgetComponentError}
         */
        setVolume(volumeToSet?: minecraftserverbindings.Vector3[] | minecraftserverbindings.BlockVolume | minecraftserverbindings.BlockVolumeBase | RelativeVolumeListBlockVolume | minecraftserverbindings.Vector3): void;
    }
    class WidgetGroup {
        private constructor();
        /**
    ...
    interface WidgetComponentBoundingBoxOptions extends WidgetComponentBaseOptions {
        boundsOffset?: minecraftserverbindings.Vector3;
        enableResizeHandles?: Axis;
        hullColor?: minecraftserverbindings.RGBA;
    ...
    interface WidgetComponentClipboardOptions extends WidgetComponentBaseOptions {
        clipboardOffset?: minecraftserverbindings.Vector3;
        highlightHullColor?: minecraftserverbindings.RGBA;
        highlightOutlineColor?: minecraftserverbindings.RGBA;
        hullColor?: minecraftserverbindings.RGBA;
    ...
    interface WidgetComponentEntityOptions extends WidgetComponentBaseOptions {
        deselectedAnimation?: string;
        isClickable?: boolean;
        selectedAnimation?: string;
    }
    interface WidgetComponentGizmoOptions extends WidgetComponentBaseOptions {
        axes?: Axis;
    ...
    interface WidgetComponentGridOptions extends WidgetComponentBaseOptions {
        color?: minecraftserverbindings.RGBA;
        gridCount?: minecraftserverbindings.Vector2;
        gridSize?: minecraftserverbindings.Vector2;
        plane?: Plane;
    }
    interface WidgetComponentGuideOptions extends WidgetComponentBaseOptions {
    }
    interface WidgetComponentRenderPrimitiveOptions extends WidgetComponentBaseOptions {
    }
    interface WidgetComponentSplineOptions extends WidgetComponentBaseOptions {
        controlPoints: Widget[];
        splineType?: SplineType;
    }
    interface WidgetComponentTextOptions extends WidgetComponentBaseOptions {
        color?: minecraftserverbindings.RGBA;
    }
    interface WidgetComponentVolumeOutlineOptions extends WidgetComponentBaseOptions {
        highlightHullColor?: minecraftserverbindings.RGBA;
        highlightOutlineColor?: minecraftserverbindings.RGBA;
        hullColor?: minecraftserverbindings.RGBA;
        mirror?: minecraftserverbindings.StructureMirrorAxis;
