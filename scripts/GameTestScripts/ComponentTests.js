...
GameTest.register("ComponentTests", "color_component", (test) => {
    const sheep = test.spawn("minecraft:sheep", { x: 1, y: 2, z: 1 });
    let counter = 0;
    test.succeedWhen(() => {
...
GameTest.register("ComponentTests", "get_component_on_dead_entity", (test) => {
    const horse = test.spawn("minecraft:horse", { x: 1, y: 2, z: 1 });
    horse.kill();
...
GameTest.register("ComponentTests", "is_saddled_component", (test) => {
    const pig = test.spawn("minecraft:pig<minecraft:ageable_grow_up>", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "get_components", (test) => {
    const horse = test.spawn("minecraft:horse<minecraft:ageable_grow_up>", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "leashable_component", (test) => {
    const pig1 = test.spawn("minecraft:pig<minecraft:ageable_grow_up>", { x: 1, y: 2, z: 1 });
    const pig2 = test.spawn("minecraft:pig<minecraft:ageable_grow_up>", { x: 3, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "rideable_component", (test) => {
    const pig = test.spawn("minecraft:pig<minecraft:ageable_grow_up>", { x: 1, y: 2, z: 1 });
    const boat = test.spawn("minecraft:boat", { x: 3, y: 2, z: 1 });
    const skeletonHorse = test.spawn("minecraft:skeleton_horse<minecraft:ageable_grow_up>", { x: 5, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "healable_component", (test) => {
    const parrot = test.spawn("minecraft:parrot", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "movement_amphibious_component", (test) => {
    const turtle = test.spawn("turtle", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "movement_basic_component", (test) => {
    const chicken = test.spawn("chicken", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "movement_fly_component", (test) => {
    const parrot = test.spawn("parrot", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "movement_generic_component", (test) => {
    const drowned = test.spawn("drowned", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "movement_glide_component", (test) => {
    const phantom = test.spawn("phantom", { x: 2, y: 2, z: 2 });
...
GameTest.register("ComponentTests", "movement_jump_component", (test) => {
    const slime = test.spawn("slime", { x: 2, y: 2, z: 2 });
...
GameTest.register("ComponentTests", "movement_skip_component", (test) => {
    const rabbit = test.spawn("rabbit", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "movement_sway_component", (test) => {
    const salmon = test.spawn("salmon", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "ageable_component", (test) => {
    const horse = test.spawn("minecraft:horse<minecraft:entity_born>", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "addrider_component", (test) => {
    const ravager = test.spawn("minecraft:ravager<minecraft:spawn_for_raid_with_pillager_rider>", { x: 2, y: 2, z: 2 });
...
GameTest.register("ComponentTests", "navigation_climb_component", (test) => {
    const spider = test.spawn("spider", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "navigation_float_component", (test) => {
    const bat = test.spawn("bat", { x: 1, y: 2, z: 1 });
...
GameTest.register("ComponentTests", "navigation_generic_component", (test) => {
    const dolphin = test.spawn("dolphin", { x: 2, y: 2, z: 2 });
...
GameTest.register("ComponentTests", "inventory_component", (test) => {
    const rightChestCart = test.spawn("chest_minecart", { x: 1, y: 3, z: 1 });
    const leftChestCart = test.spawn("chest_minecart", { x: 2, y: 3, z: 1 });
...
GameTest.register("ComponentTests", "lava_movement_component", (test) => {
    const strider = test.spawn("strider", { x: 1, y: 2, z: 1 });
...
GameTest.registerAsync("ComponentTests", "item_component", async (test) => {
    ...
    .structureName("ComponentTests:platform")
    .tag(GameTest.Tags.suiteDefault);
//# sourceMappingURL=ComponentTests.js.map