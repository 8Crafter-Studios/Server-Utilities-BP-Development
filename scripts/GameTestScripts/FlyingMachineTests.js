...
import { BlockLocationIterator, MinecraftBlockTypes } from "@minecraft/server";
GameTest.register("FlyingMachineTests", "machine_a", (test) => {
    const triggerPos = new BlockLocationIterator(1, 5, 1);
    const farPos = new BlockLocationIterator(2, 3, 5);
    const nearPos = new BlockLocationIterator(2, 3, 1);
    test
        .startSequence()
        .thenExecute(() => {
...
GameTest.register("FlyingMachineTests", "machine_b", (test) => {
    const triggerPos = new BlockLocationIterator(5, 4, 1);
    const farPos = new BlockLocationIterator(3, 3, 4);
    const nearPos = new BlockLocationIterator(4, 3, 1);
    test
        .startSequence()
        .thenExecute(() => {
...
GameTest.register("FlyingMachineTests", "machine_c", (test) => {
    const triggerPos = new BlockLocationIterator(4, 4, 0);
    const farPos = new BlockLocationIterator(4, 3, 5);
    const nearPos = new BlockLocationIterator(4, 3, 2);
    const stopBlock = new BlockLocationIterator(4, 3, 4);
    test
        .startSequence()
        .thenExecute(() => {
        test.pulseRedstone(triggerPos, 2);
...
GameTest.register("FlyingMachineTests", "machine_d", (test) => {
    const triggerPos = new BlockLocationIterator(3, 7, 3);
    const dropPos = new BlockLocationIterator(5, 5, 2);
    const farPos = new BlockLocationIterator(2, 5, 8);
    const nearPos = new BlockLocationIterator(3, 5, 1);
    test
        .startSequence()
        .thenExecute(() => {
        test.setBlockType(MinecraftBlockTypes.fire, triggerPos);
...
GameTest.register("FlyingMachineTests", "machine_e", (test) => {
    const triggerPos = new BlockLocationIterator(1, 2, 1);
    const farPos = new BlockLocationIterator(1, 11, 1);
    const nearPos = new BlockLocationIterator(1, 3, 1);
    test
        .startSequence()
        .thenExecute(() => {
...
GameTest.register("FlyingMachineTests", "machine_f", (test) => {
    const triggerPos = new BlockLocationIterator(4, 6, 1);
    const farPos = new BlockLocationIterator(3, 4, 8);
    const dropPos = new BlockLocationIterator(3, 4, 6);
    const nearPos = new BlockLocationIterator(3, 4, 1);
    test
        .startSequence()
        .thenExecute(() => {
        test.setBlockType(MinecraftBlockTypes.fire, triggerPos);
...
GameTest.register("FlyingMachineTests", "machine_g", (test) => {
    const triggerPos = new BlockLocationIterator(1, 3, 0);
    const farPos = new BlockLocationIterator(2, 3, 6);
    const nearPos = new BlockLocationIterator(1, 3, 1);
    test
        .startSequence()
        .thenExecute(() => {
...
GameTest.register("FlyingMachineTests", "machine_h", (test) => {
    const triggerPos = new BlockLocationIterator(1, 4, 0);
    const farPos = new BlockLocationIterator(1, 3, 8);
    const dropPos = new BlockLocationIterator(1, 3, 7);
    const nearPos = new BlockLocationIterator(1, 4, 1);
    test
        .startSequence()
        .thenExecute(() => {
        test.pulseRedstone(triggerPos, 2);
...
GameTest.register("FlyingMachineTests", "machine_i", (test) => {
    const triggerPos = new BlockLocationIterator(4, 2, 1);
    const farPos = new BlockLocationIterator(3, 8, 1);
    const nearPos = new BlockLocationIterator(4, 3, 1);
    test
        .startSequence()
        .thenExecute(() => {
...
GameTest.register("FlyingMachineTests", "m_bedrock", (test) => {
    ...
    const sourcePos = new BlockLocationIterator(1, 3, 0);
    const targetPos = new BlockLocationIterator(8, 3, 1);
    test
        .startSequence()
        .thenExecute(() => {
...
GameTest.register("FlyingMachineTests", "m2_bedrock", (test) => {
    ...
    const triggerPos = new BlockLocationIterator(0, 3, 1);
    const sourcePos = new BlockLocationIterator(2, 3, 0);
    const targetPos = new BlockLocationIterator(6, 3, 1);
    test
        .startSequence()
        .thenExecute(() => {
        test.assertBlockPresent(MinecraftBlockTypes.slime, sourcePos, true);
...
GameTest.register("FlyingMachineTests", "m3_bedrock", (test) => {
    ...
    const triggerPos = new BlockLocationIterator(1, 3, 2);
    const sourcePos = new BlockLocationIterator(4, 3, 2);
    const targetPos = new BlockLocationIterator(7, 3, 2);
    test
        .startSequence()
        .thenExecute(() => {
        test.assertBlockPresent(MinecraftBlockTypes.slime, sourcePos, true);
...
//# sourceMappingURL=FlyingMachineTests.js.map