...
export default class GameTestExtensions {
    ...
    assertBlockProperty(propertyName, value, BlockLocationIterator) {
        this.test.assertBlockState(BlockLocationIterator, (block) => {
...
//# sourceMappingURL=GameTestExtensions.js.map