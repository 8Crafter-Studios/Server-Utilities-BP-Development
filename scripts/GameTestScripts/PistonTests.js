...
import { BlockLocationIterator, Location, MinecraftBlockTypes, ItemStack } from "@minecraft/server";
import GameTestExtensions from "./GameTestExtensions.js";
GameTest.register("PistonTests", "honey_block_entity_drag_sideways", (test) => {
    const startPos = new BlockLocationIterator(3, 4, 1);
    const endPos = new BlockLocationIterator(2, 4, 1);
    const pullLeverPos = new BlockLocationIterator(0, 3, 0);
...
GameTest.register("PistonTests", "quasiconnectivity", (test) => {
    const topStartPos = new BlockLocationIterator(3, 3, 0);
    const bottomStartPos = new BlockLocationIterator(3, 2, 0);
    const topEndPos = new BlockLocationIterator(2, 3, 0);
    const bottomEndPos = new BlockLocationIterator(2, 2, 0);
    const pullLeverPos = new BlockLocationIterator(0, 4, 0);
    test.pullLever(pullLeverPos);
    test
        .startSequence()
        .thenWaitAfter(3, () => {
...
GameTest.register("PistonTests", "redstone_simple_vertical_bud", (test) => {
    const blockPos = new BlockLocationIterator(0, 5, 0);
    const setblockPos = new BlockLocationIterator(0, 1, 0);
...
GameTest.register("PistonTests", "redstone_simple_horizontal_bud", (test) => {
    const extendedPos = new BlockLocationIterator(3, 2, 0);
    const retractedPos = new BlockLocationIterator(2, 2, 0);
    test.setBlockType(MinecraftBlockTypes.stone, new BlockLocationIterator(0, 1, 0));
    test
        .startSequence()
        .thenWaitAfter(3, () => {
...
GameTest.register("PistonTests", "redstone_bud", (test) => {
    const blockPos = new BlockLocationIterator(0, 3, 5);
    const pullLeverPos = new BlockLocationIterator(0, 4, 0);
    test.pullLever(pullLeverPos);
    test
        .startSequence()
...
GameTest.register("PistonTests", "slime_block_pull", (test) => {
    const targetPos = new BlockLocationIterator(3, 3, 0);
    const pullLeverPos = new BlockLocationIterator(0, 4, 0);
...
GameTest.register("PistonTests", "normal_extend", (test) => {
    const targetPos = new BlockLocationIterator(3, 2, 0);
    const pullLeverPos = new BlockLocationIterator(0, 3, 0);
...
GameTest.register("PistonTests", "push_limit", (test) => {
    const underLimitTip = new BlockLocationIterator(0, 2, 6);
    const overLimitTip = new BlockLocationIterator(2, 2, 6);
    const pullLeverPos = new BlockLocationIterator(1, 2, 0);
    const underLimitExtendedTip = new BlockLocationIterator(0, 2, 7);
...
GameTest.register("PistonTests", "block_leave", (test) => {
    const trigger = new BlockLocationIterator(3, 1, 1);
    const retracted = new BlockLocationIterator(1, 1, 1);
    const extended = new BlockLocationIterator(0, 1, 1);
...
GameTest.register("PistonTests", "update_order", (test) => {
    const posA = new BlockLocationIterator(2, 1, 1);
    const posB = new BlockLocationIterator(2, 1, 0);
    const posC = new BlockLocationIterator(3, 1, 0);
    const posD = new BlockLocationIterator(1, 1, 0);
    const trigger = new BlockLocationIterator(6, 2, 2);
...
GameTest.register("PistonTests", "double_extender", (test) => {
    const pullLeverPos = new BlockLocationIterator(2, 3, 2);
    const blockPresentPosA = new BlockLocationIterator(0, 2, 2);
    const blockPresentPosB = new BlockLocationIterator(0, 2, 4);
    test.pullLever(pullLeverPos);
...
GameTest.register("PistonTests", "triple_extender", (test) => {
    const retracted = new BlockLocationIterator(0, 4, 4);
    const extended = new BlockLocationIterator(0, 1, 4);
    const trigger = new BlockLocationIterator(0, 8, 0);
    const assertBlockPresentA = new BlockLocationIterator(0, 7, 4);
    const assertBlockPresentB = new BlockLocationIterator(0, 6, 4);
    const assertBlockPresentC = new BlockLocationIterator(0, 5, 4);
...
GameTest.register("PistonTests", "triple_extender_bedrock", (test) => {
    const retracted = new BlockLocationIterator(0, 4, 4);
    const extended = new BlockLocationIterator(0, 1, 4);
    const trigger = new BlockLocationIterator(0, 7, 0);
    const assertBlockPresentA = new BlockLocationIterator(0, 7, 4);
    const assertBlockPresentB = new BlockLocationIterator(0, 6, 4);
    const assertBlockPresentC = new BlockLocationIterator(0, 5, 4);
    const assertBlockPresentD = new BlockLocationIterator(0, 3, 4);
    test.pressButton(trigger);
    test
        .startSequence()
        .thenWait(() => {
...
GameTest.register("PistonTests", "monostable", (test) => {
    ...
    const lampPos = new BlockLocationIterator(0, 3, 5);
    const pullLeverPos = new BlockLocationIterator(0, 2, 0);
...
GameTest.register("PistonTests", "instant_retraction", (test) => {
    const airPos = new BlockLocationIterator(2, 1, 1);
    const concretePos = new BlockLocationIterator(0, 1, 3);
...
GameTest.register("PistonTests", "instant_repeater", (test) => {
    const testEx = new GameTestExtensions(test);
    const triggerPos = new BlockLocationIterator(0, 3, 0);
    const outputPos = new BlockLocationIterator(0, 3, 25);
...
GameTest.register("PistonTests", "entity_backside", (test) => {
    const buttonPos = new BlockLocationIterator(2, 2, 0);
    const lampFailPos = new BlockLocationIterator(4, 3, 2);
...
GameTest.register("PistonTests", "redstone_matrix", (test) => {
    const buttonPos = new BlockLocationIterator(1, 3, 1);
    const wirePos = new BlockLocationIterator(1, 4, 2);
    test.pressButton(buttonPos);
    test
        .startSequence()
        .thenIdle(30)
...
GameTest.register("PistonTests", "one_tick_pulse", (test) => {
    const retractedPos = new BlockLocationIterator(1, 2, 3);
    const extendedPos = new BlockLocationIterator(0, 2, 3);
    const pressButtonPos = new BlockLocationIterator(2, 2, 0);
...
GameTest.register("PistonTests", "backside", (test) => {
    var buttonsBlockPos = [
        new BlockLocationIterator(3, 3, 0),
        new BlockLocationIterator(1, 2, 1),
        new BlockLocationIterator(4, 3, 3),
        new BlockLocationIterator(1, 4, 3),
        new BlockLocationIterator(3, 3, 6),
        new BlockLocationIterator(0, 3, 5),
    ];
...
GameTest.register("PistonTests", "observer_retraction_timing", (test) => {
    const testEx = new GameTestExtensions(test);
    const levelPos = new BlockLocationIterator(3, 2, 2);
    const observerPos = new BlockLocationIterator(2, 2, 1);
...
GameTest.register("PistonTests", "random_tick_forcer", (test) => {
    const buttonPos = new BlockLocationIterator(1, 3, 0);
    const flower = new BlockLocationIterator(1, 3, 6);
    const aboveFlower = new BlockLocationIterator(1, 4, 6);
    test.pressButton(buttonPos);
    test
        .startSequence()
        .thenIdle(20)
...
GameTest.register("PistonTests", "honey_block_entity_drag_down", (test) => {
    const leverPos = new BlockLocationIterator(1, 1, 0);
    const entityTypePos = new BlockLocationIterator(1, 4, 1);
...
GameTest.register("PistonTests", "backside_fence", (test) => {
    const centerPos = new BlockLocationIterator(2, 2, 2);
    ...
    test
        ...
        test.assert(connectivity.east && connectivity.west && connectivity.north && connectivity.south, "Fence should connect to pistons");
    })
        .thenWait(() => {
        connectivity = test.getFenceConnectivity(centerPos);
        test.assert(!(connectivity.east && connectivity.west && connectivity.north && connectivity.south), "Fence should stay connected to pistons");
    })
        .thenFail("Fence didn't stay connected to pistons");
}).tag(GameTest.Tags.suiteDefault);
//# sourceMappingURL=PistonTests.js.map