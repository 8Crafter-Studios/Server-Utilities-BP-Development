...
GameTest.register("ItemEnchantmentsTests", "item_can_have_enchantments_applied", (test) => {
    ...
    let addSuccess = enchantments.addEnchantment(new Enchantment("fire_aspect", 2));
...
GameTest.register("ItemEnchantmentsTests", "item_enchantments_conflict_prevent_adding", (test) => {
    ...
    const enchantsComponent = itemStack.getComponent("minecraft:enchantments");
    const enchantments = enchantsComponent.enchantments;
    enchantments.addEnchantment(new Enchantment("fire_aspect", 2));
    let addSuccess = enchantments.addEnchantment(new Enchantment("aqua_affinity", 1));
...
GameTest.register("ItemEnchantmentsTests", "get_all_enchantments", (test) => {
    ...
    const enchantsComponent = itemStack.getComponent("minecraft:enchantments");
    const enchantments = enchantsComponent.enchantments;
    enchantments.addEnchantment(new Enchantment("fire_aspect", 1));
    enchantments.addEnchantment(new Enchantment("bane_of_arthropods", 2));
    enchantments.addEnchantment(new Enchantment("knockback"));
    ...
    .structureName("ComponentTests:platform")
    .tag(GameTest.Tags.suiteDefault);
//# sourceMappingURL=ItemEnchantmentsTests.js.map