...
import { BlockLocationIterator, MinecraftBlockTypes, Direction } from "@minecraft/server";
import GameTestExtensions from "./GameTestExtensions.js";
GameTest.register("MinecartTests", "turn", (test) => {
    const minecartEntityType = "minecart";
    const endPos = new BlockLocationIterator(1, 2, 2);
    const startPos = new BlockLocationIterator(1, 2, 0);
...
GameTest.register("MinecartTests", "furnace_corner", (test) => {
    ...
    const endPos = new BlockLocationIterator(2, 2, 1);
    const startPos = new BlockLocationIterator(1, 2, 0);
...
GameTest.register("MinecartTests", "detector_rail_slope", (test) => {
    ...
    const poweredDetectorPos = new BlockLocationIterator(2, 2, 1);
    ...
    test.pressButton(new BlockLocationIterator(0, 3, 3));
...
GameTest.register("MinecartTests", "detector_rail_piston", (test) => {
    const pistonRight = new BlockLocationIterator(5, 3, 0);
    const pistonLeft = new BlockLocationIterator(0, 3, 0);
    const torchRight = new BlockLocationIterator(3, 2, 0);
    const torchLeft = new BlockLocationIterator(2, 2, 0);
    ...
    test
        ...
        minecart = test.spawn("minecart", new BlockLocationIterator(3, 3, 1));
    })
        .thenExecuteAfter(3, () => {
...
function runWaterSlowdown(test, entityType) {
    const buttonPos = new BlockLocationIterator(1, 4, 2);
    const dryTrackEndPos = new BlockLocationIterator(8, 3, 1);
    const wetTrackEndPos = new BlockLocationIterator(8, 3, 3);
...
GameTest.register("MinecartTests", "water_slowdown_powered_furnace_cart", (test) => {
    const buttonPos = new BlockLocationIterator(1, 4, 4);
    const dryTrackEndPos = new BlockLocationIterator(7, 3, 1);
    const wetTrackEndPos = new BlockLocationIterator(7, 3, 7);
...
GameTest.register("MinecartTests", "water_slowdown_vertical", (test) => {
    const buttonPos = new BlockLocationIterator(1, 6, 2);
    const dryTrackEndPos = new BlockLocationIterator(3, 2, 1);
    const wetTrackEndPos = new BlockLocationIterator(3, 2, 3);
...
GameTest.register("MinecartTests", "water_slowdown_slope_down", (test) => {
    const buttonPos = new BlockLocationIterator(1, 6, 2);
    const dryTrackEndPos = new BlockLocationIterator(6, 2, 1);
    const wetTrackEndPos = new BlockLocationIterator(6, 2, 3);
    runWaterSlowdownTest(test, buttonPos, dryTrackEndPos, wetTrackEndPos, "minecart");
})
    .tag("suite:java_parity")
    .tag(GameTest.Tags.suiteDisabled); //the minecart cannot slow down in water.
...
GameTest.register("MinecartTests", "water_slowdown_slope_up", (test) => {
    ...
    const dryTrackEndPos = new BlockLocationIterator(7, 5, 0);
    const wetTrackEndPos = new BlockLocationIterator(7, 5, 2);
    runWaterSlowdownTest(test, buttonPos, dryTrackEndPos, wetTrackEndPos, "minecart");
})
    .tag("suite:java_parity")
    .tag(GameTest.Tags.suiteDisabled); //the minecart cannot slow down in water.
...
GameTest.register("MinecartTests", "water_slowdown_powered_rail_furnace", (test) => {
    const buttonPos = new BlockLocationIterator(1, 3, 1);
    const dryTrackEndPos = new BlockLocationIterator(7, 2, 0);
    const wetTrackEndPos = new BlockLocationIterator(7, 2, 2);
    runWaterSlowdownTest(test, buttonPos, dryTrackEndPos, wetTrackEndPos, "furnace_minecart");
})
    .tag("suite:java_parity")
    .tag(GameTest.Tags.suiteDisabled); //furnace_minecart doesn't exist in bedrock
//# sourceMappingURL=MinecartTests.js.map