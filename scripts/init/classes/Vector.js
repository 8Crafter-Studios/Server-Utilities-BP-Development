import { Vector3Builder, Vector3Utils, VECTOR3_ZERO, VECTOR3_ONE, VECTOR3_UP, VECTOR3_DOWN, VECTOR3_NORTH, VECTOR3_SOUTH, VECTOR3_EAST, VECTOR3_WEST, VECTOR3_RIGHT, VECTOR3_LEFT, VECTOR3_BACK, VECTOR3_FORWARD } from "@minecraft/math";
export class Vector extends Vector3Builder {
    zero = VECTOR3_ZERO;
    one = VECTOR3_ONE;
    up = VECTOR3_UP;
    down = VECTOR3_DOWN;
