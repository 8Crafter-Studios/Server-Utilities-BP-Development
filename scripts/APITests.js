...
GameTest.register("APITests", "on_entity_created", (test) => {
  ...
  test.spawn("minecraft:horse<minecraft:ageable_grow_up>", new BlockLocationIterator(1, 2, 1));
...
GameTest.register("APITests", "assert_is_waterlogged", (test) => {
  const waterChestLoc = new BlockLocationIterator(5, 2, 1);
  const waterLoc = new BlockLocationIterator(4, 2, 1);
  const chestLoc = new BlockLocationIterator(2, 2, 1);
  const airLoc = new BlockLocationIterator(1, 2, 1);
...
GameTest.register("APITests", "assert_redstone_power", (test) => {
  const redstoneBlockLoc = new BlockLocationIterator(3, 2, 1);
  const redstoneTorchLoc = new BlockLocationIterator(2, 2, 1);
  const poweredLampLoc = new BlockLocationIterator(1, 2, 1);
  const unpoweredLampLoc = new BlockLocationIterator(0, 2, 1);
  const airLoc = new BlockLocationIterator(3, 2, 0);
  const redstoneWireLoc = new BlockLocationIterator(0, 1, 0);
...
GameTest.register("APITests", "spawn_item", (test) => {
  ...
  test.succeedWhen(() => {
    test.assertEntityPresent("minecraft:item", new BlockLocationIterator(1, 2, 1), true);
  });
}).tag(GameTest.Tags.suiteDefault);

GameTest.register("APITests", "assert_entity_data", (test) => {
  const pigId = "minecraft:pig<minecraft:ageable_grow_up>";
  const pigLoc = new BlockLocationIterator(1, 2, 1);
...
GameTest.register("APITests", "add_effect", (test) => {
  ...
  const villagerLoc = new BlockLocationIterator(1, 2, 1);
...
GameTest.register("APITests", "assert_entity_present", (test) => {
  ...
  const villagerLoc = new BlockLocationIterator(1, 2, 3);
  const emeraldItem = new ItemStack(MinecraftItemTypes.emerald, 1, 0);
  const emeraldItemLoc = new BlockLocationIterator(3, 2, 3);
  const minecartId = "minecraft:minecart";
  const minecartLoc = new BlockLocationIterator(3, 2, 1);
  const armorStandId = "minecraft:armor_stand";
  const armorStandLoc = new BlockLocationIterator(1, 2, 1);
  ...
  test.succeedWhen(() => {
    ...
    for (let x = -1; x <= 1; x++) {
      for (let z = -1; z <= 1; z++) {
        let offsetLoc = new BlockLocationIterator(minecartLoc.x + x, minecartLoc.y, minecartLoc.z + z);
        if (x == 0 && z == 0) {
...
GameTest.register("APITests", "assert_entity_not_present", (test) => {
  ...
  const armorStandLoc = new BlockLocationIterator(1, 2, 1);
  const airLoc = new BlockLocationIterator(0, 2, 1);
...
GameTest.register("APITests", "assert_item_entity_count_is", (test) => {
  let oneItemLoc = new BlockLocationIterator(3, 2, 1);
  let fiveItemsLoc = new BlockLocationIterator(1, 2, 1);
  let noItemsLoc = new BlockLocationIterator(2, 2, 1);
  let diamondPickaxeLoc = new BlockLocationIterator(2, 2, 4);
...
GameTest.register("APITests", "pulse_redstone", (test) => {
  const pulseLoc = new BlockLocationIterator(1, 2, 2);
  const lampLoc = new BlockLocationIterator(1, 2, 1);
...
GameTest.register("APITests", "block_location", (test) => {
  let testLoc = new BlockLocationIterator(1, 1, 1);
  let worldLoc = test.worldBlockLocationIterator(testLoc);
  let relativeLoc = test.relativeBlockLocationIterator(worldLoc);
...
GameTest.register("APITests", "create_explosion_basic", (test) => {
  const center = new BlockLocationIterator(2, 3, 2);

  test.assertBlockPresent(MinecraftBlockTypes.cobblestone, center, true);

  const loc = test.worldBlockLocationIterator(center);
  ...
  for (let x = 1; x <= 3; x++) {
    for (let y = 2; y <= 4; y++) {
      for (let z = 1; z <= 3; z++) {
        test.assertBlockPresent(MinecraftBlockTypes.cobblestone, new BlockLocationIterator(x, y, z), false);
      }
    }
  }
...
GameTest.register("APITests", "create_explosion_advanced", (test) => {
  ...
  const center = new BlockLocationIterator(3, 3, 3);

  const pigId = "minecraft:pig<minecraft:ageable_grow_up>";
  const pigLoc = new BlockLocationIterator(3, 4, 3);
  test.spawn(pigId, pigLoc);
  ...
  const creeper = test.spawn("minecraft:creeper", new BlockLocationIterator(1, 2, 1));
  ...
  let findFire = () => {
    ...
    for (let x = 0; x <= 6; x++) {
      for (let z = 0; z <= 6; z++) {
        try {
          test.assertBlockPresent(MinecraftBlockTypes.fire, new BlockLocationIterator(x, 3, z), true);
          foundFire = true;
          break;
        } catch (e) {}
      }
  ...
  const belowWaterLoc = new BlockLocationIterator(3, 1, 3);
...
GameTest.register("APITests", "triggerEvent", (test) => {
  const creeper = test.spawn("creeper", new BlockLocationIterator(1, 2, 1));
...
GameTest.register("APITests", "add_effect_event", (test) => {
  const villagerId = "minecraft:villager_v2<minecraft:ageable_grow_up>";
  const villager = test.spawn(villagerId, new BlockLocationIterator(1, 2, 1));

  const pigId = "minecraft:pig<minecraft:ageable_grow_up>";
  const pig = test.spawn(pigId, new BlockLocationIterator(1, 2, 1));
...
GameTest.register("APITests", "piston", (test) => {
  const dimension = test.getDimension();
  const pistonLoc = new BlockLocationIterator(1, 2, 1);
  const redstoneLoc = new BlockLocationIterator(1, 2, 0);
  const pistonComp = test.getDimension().getBlock(test.worldBlockLocationIterator(pistonLoc)).getComponent("piston");
...
GameTest.register("APITests", "piston_event", (test) => {
  ...
  const redstoneLoc = new BlockLocationIterator(1, 2, 0);
  const pistonLoc = new BlockLocationIterator(1, 2, 1);
  const planksLoc = new BlockLocationIterator(2, 2, 1);
  ...
  const pistonCallback = world.events.pistonActivate.subscribe((pistonEvent) => {
    ...
    if (pistonEvent.piston.location.equals(test.worldBlockLocationIterator(pistonLoc))) {
...
GameTest.registerAsync("APITests", "lever_event", async (test) => {
  const leverLoc = new BlockLocationIterator(1, 2, 1);
  let leverPower = false;

  const leverCallback = world.events.leverActivate.subscribe((leverEvent) => {
    let blockLoc = test.relativeBlockLocationIterator(leverEvent.block.location);
...
GameTest.registerAsync("APITests", "lever_event_player", async (test) => {
  ...
  test.setBlockType(MinecraftBlockTypes.lever, leverLoc);
  const simulatedPlayer = test.spawnSimulatedPlayer(new BlockLocationIterator(2, 2, 1), "Lever_Toggle_Player");
  await test.idle(5);
...
GameTest.registerAsync("APITests", "button_event", async (test) => {
  const buttonLoc = new BlockLocationIterator(1, 2, 1);
  ...
  const buttonCallback = world.events.buttonPush.subscribe((buttonEvent) => {
    let blockLoc = test.relativeBlockLocationIterator(buttonEvent.block.location);
...
GameTest.registerAsync("APITests", "button_event_player", async (test) => {
  ...
  const simulatedPlayer = test.spawnSimulatedPlayer(new BlockLocationIterator(2, 2, 1), "Button_Push_Player");
  await test.idle(5);
  test.setBlockPermutation(buttonPermutation, buttonLoc);
...
GameTest.register("APITests", "assert_can_reach_location", (test) => {
  const villagerId = "minecraft:villager_v2<minecraft:ageable_grow_up>";
  const villager1 = test.spawn(villagerId, new BlockLocationIterator(1, 2, 1));
  const villager2 = test.spawn(villagerId, new BlockLocationIterator(1, 2, 3));
  const villager3 = test.spawn(villagerId, new BlockLocationIterator(1, 2, 5));
  test.assertCanReachLocation(villager1, new BlockLocationIterator(4, 2, 1), true);
  test.assertCanReachLocation(villager2, new BlockLocationIterator(4, 2, 3), false);
  test.assertCanReachLocation(villager3, new BlockLocationIterator(4, 2, 5), false);
  test.succeed();
}).tag(GameTest.Tags.suiteDefault);

const isLocationInTest = (test, worldLoc) => {
  const size = 4;
  let loc = test.relativeBlockLocationIterator(worldLoc);
  return loc.x >= 0 && loc.y >= 0 && loc.z >= 0 && loc.x < size && loc.y < size && loc.z < size;
};

GameTest.register("APITests", "explosion_event", (test) => {
  let exploded = false;
  const cobblestoneLoc = new BlockLocationIterator(1, 3, 1);
  const polishedAndesiteLoc = new BlockLocationIterator(1, 1, 1);
  ...
  const beforeExplosionCallback = world.events.beforeExplosion.subscribe((explosionEvent) => {
    ...
    explosionEvent.impactedBlocks = [test.worldBlockLocationIterator(cobblestoneLoc)];
  });
  ...
  test
    ...
    .thenExecute(() => {
      ...
      test.spawn("tnt", new BlockLocationIterator(1, 2, 1));
    })
    .thenExecuteAfter(85, () => {
...
GameTest.register("APITests", "connectivity", (test) => {
  const centerLoc = new BlockLocationIterator(1, 2, 1);
...
GameTest.register("APITests", "walk_to_location", (test) => {
  const spawnLoc = new BlockLocationIterator(1, 2, 1);
...
GameTest.register("APITests", "walk_to_location_far", (test) => {
  const targetLoc = new BlockLocationIterator(3, 2, 17);
  const zombie = test.spawnWithoutBehaviors("minecraft:zombie<minecraft:ageable_grow_up>", new BlockLocationIterator(1, 2, 1));
...
GameTest.register("APITests", "spread_from_face_toward_direction", (test) => {
  ...
  let multifaceLoc = new BlockLocationIterator(1, 4, 0);
  let spreadLoc = new BlockLocationIterator(1, 3, 0);
...
GameTest.register("APITests", "cauldron", (test) => {
  const loc = new BlockLocationIterator(0, 1, 0);
...
GameTest.register("APITests", "jukebox", (test) => {
  var jukeboxBlock = test.getBlock(new BlockLocationIterator(0, 1, 0));
...
GameTest.register("APITests", "maybe_fill_cauldron", (test) => {
  test
    .startSequence()
    .thenExecute(() => {
      test.triggerInternalBlockEvent(new BlockLocationIterator(1, 3, 1), "minecraft:drip");
      test.triggerInternalBlockEvent(new BlockLocationIterator(3, 3, 1), "minecraft:drip");
    })
    .thenIdle(61)
    .thenExecute(() => {
      var waterCauldron = test.getBlock(new BlockLocationIterator(3, 2, 1));
      var lavaCauldron = test.getBlock(new BlockLocationIterator(1, 2, 1));
      test.assert(
...
GameTest.register("APITests", "grow_pointed_dripstone", (test) => {
  test.triggerInternalBlockEvent(new BlockLocationIterator(1, 5, 1), "grow_stalagtite");
  test.assertBlockPresent(MinecraftBlockTypes.pointedDripstone, new BlockLocationIterator(1, 4, 1), true);
  test.assertBlockPresent(MinecraftBlockTypes.pointedDripstone, new BlockLocationIterator(1, 2, 1), false);

  test.triggerInternalBlockEvent(new BlockLocationIterator(1, 5, 1), "grow_stalagmite");
  test.assertBlockPresent(MinecraftBlockTypes.pointedDripstone, new BlockLocationIterator(1, 4, 1), true);
  test.assertBlockPresent(MinecraftBlockTypes.pointedDripstone, new BlockLocationIterator(1, 2, 1), true);

  test.assertBlockPresent(MinecraftBlockTypes.pointedDripstone, new BlockLocationIterator(1, 3, 1), false);
...
GameTest.register("APITests", "vines", (test) => {
  ...
  test.triggerInternalBlockEvent(new BlockLocationIterator(1, 4, 2), "grow_down", [southBitmask | northBitmask]);
  ...
  test.triggerInternalBlockEvent(new BlockLocationIterator(1, 4, 2), "grow_up", [allBitmask]);
  testEx.assertBlockProperty(BlockProperties.vineDirectionBits, southBitmask | eastBitmask, new BlockLocationIterator(1, 5, 2));

  test.triggerInternalBlockEvent(new BlockLocationIterator(7, 2, 1), "grow_sideways", [
    testEx.getVineDirection(test.rotateDirection(Direction.west)),
  ]);
  testEx.assertBlockProperty(BlockProperties.vineDirectionBits, southBitmask, new BlockLocationIterator(6, 2, 1));

  test.triggerInternalBlockEvent(new BlockLocationIterator(6, 2, 1), "grow_sideways", [
    testEx.getVineDirection(test.rotateDirection(Direction.west)),
  ]);
  testEx.assertBlockProperty(BlockProperties.vineDirectionBits, southBitmask | westBitmask, new BlockLocationIterator(6, 2, 1));

  test.triggerInternalBlockEvent(new BlockLocationIterator(7, 2, 1), "grow_sideways", [
    testEx.getVineDirection(test.rotateDirection(Direction.east)),
  ]);
  testEx.assertBlockProperty(BlockProperties.vineDirectionBits, westBitmask, new BlockLocationIterator(8, 2, 2));
...
GameTest.register("APITests", "tags", (test) => {
  const player = test.spawnSimulatedPlayer(new BlockLocationIterator(1, 2, 1), "tag_player");
  const dimension = test.getDimension();
...
GameTest.register("APITests", "cant_set_target", async (test) => {
  ...
  let wolf = test.spawn("minecraft:wolf<minecraft:ageable_grow_up>", new BlockLocationIterator(2, 2, 1));
...
GameTest.register("APITests", "teleport_mob", async (test) => {
  let sheepSpawn = new BlockLocationIterator(0, 2, 0);
  let teleportBlockLoc = new BlockLocationIterator(2, 2, 2);
...
GameTest.register("APITests", "teleport_mob_facing", async (test) => {
  let playerSpawn = new BlockLocationIterator(0, 2, 0);
  ...
  let facingBlockLoc = new BlockLocationIterator(2, 3, 0);
...
GameTest.register("APITests", "view_vector", (test) => {
  ...
  player.lookAtBlock(new BlockLocationIterator(0, 3, 1));
  test
    .startSequence()
    .thenExecuteAfter(10, () => {
      test.assert(
      ...
      player.lookAtBlock(new BlockLocationIterator(2, 3, 0));
    })
    .thenExecuteAfter(10, () => {
      test.assert(
      ...
      player.lookAtBlock(new BlockLocationIterator(1, 5, 1));
    })
    .thenExecuteAfter(10, () => {
      test.assert(
...
GameTest.register("APITests", "lore", (test) => {
  ...
  const chestCart = test.spawn("chest_minecart", new BlockLocationIterator(1, 3, 1));
...
GameTest.registerAsync("APITests", "data_driven_actor_event", async (test) => {
  ...
  const llama = test.spawn("minecraft:llama", new BlockLocationIterator(1, 2, 1));
  const villager = test.spawn("minecraft:villager_v2", new BlockLocationIterator(1, 2, 1));
...
GameTest.registerAsync("APITests", "property_components", async (test) => {
  ...
  const zombie = test.spawn("minecraft:zombie<minecraft:ageable_grow_up>", new BlockLocationIterator(1, 2, 1));
  testComponent(zombie, "can_climb");

  const bee = test.spawn("bee", new BlockLocationIterator(1, 2, 1));
  ...
  const magma_cube = test.spawn("magma_cube", new BlockLocationIterator(1, 2, 1));
  testComponent(magma_cube, "fire_immune");

  const horse = test.spawn("horse", new BlockLocationIterator(1, 2, 1));
  ...
  const llama = test.spawn("llama", new BlockLocationIterator(1, 2, 1));
  ...
  const pillager = test.spawn("pillager", new BlockLocationIterator(1, 2, 1));
  pillager.triggerEvent("minecraft:spawn_as_illager_captain");
  await test.idle(1);
  testComponent(pillager, "is_illager_captain");

  const ravager = test.spawn("ravager", new BlockLocationIterator(1, 2, 1));
  ravager.triggerEvent("minecraft:become_stunned");
  await test.idle(1);
  testComponent(ravager, "is_stunned");

  const sheep = test.spawn("sheep", new BlockLocationIterator(1, 2, 1));
  ...
  const cat = test.spawn("cat", new BlockLocationIterator(1, 2, 1));
  cat.triggerEvent("minecraft:spawn_midnight_cat");
  await test.idle(1);
  testComponent(cat, "variant", 9, false);

  const tnt = test.spawn("tnt_minecart", new BlockLocationIterator(1, 2, 1));
...
GameTest.register("APITests", "entity_hit_event_hits_entity", async (test) => {
  const player = test.spawnSimulatedPlayer(new BlockLocationIterator(1, 2, 1));
  const cow = test.spawn("minecraft:cow<minecraft:ageable_grow_up>", new BlockLocationIterator(3, 2, 3));
...
GameTest.register("APITests", "entity_hit_event_hits_block", async (test) => {
  const player = test.spawnSimulatedPlayer(new BlockLocationIterator(1, 2, 1));
  const blockLoc = new BlockLocationIterator(1, 2, 1);
...
GameTest.registerAsync("APITests", "entity_hurt_event_skeleton_hurts_player", async (test) => {
  const player = test.spawnSimulatedPlayer(new BlockLocationIterator(1, 2, 1));
  const skeleton = test.spawn("skeleton", new BlockLocationIterator(3, 2, 3));
...
GameTest.registerAsync("APITests", "entity_hurt_event_player_kills_chicken", async (test) => {
  const player = test.spawnSimulatedPlayer(new BlockLocationIterator(1, 2, 1));
  const chicken = test.spawn("minecraft:chicken<minecraft:ageable_grow_up>", new BlockLocationIterator(3, 2, 3));
...
GameTest.registerAsync("APITests", "projectile_hit_event_block", async (test) => {
  const player = test.spawnSimulatedPlayer(new BlockLocationIterator(1, 2, 1));
  const targetLoc = new BlockLocationIterator(1, 3, 7);

  let projectileHitCallback = world.events.projectileHit.subscribe((e) => {
    if (e.blockHit && test.relativeBlockLocationIterator(e.blockHit.block.location).equals(targetLoc)) {
...
GameTest.registerAsync(`APITests`, `teleport_keep_velocity_mob`, async (test) => {
  let pig1 = test.spawn(`minecraft:pig<minecraft:ageable_grow_up>`, new BlockLocationIterator(0, 10, 0));
  let pig2 = test.spawn(`minecraft:pig<minecraft:ageable_grow_up>`, new BlockLocationIterator(0, 10, 2));
  let simPlayer1 = test.spawnSimulatedPlayer(new BlockLocationIterator(2, 10, 0));
