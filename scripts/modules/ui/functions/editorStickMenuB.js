...
export function editorStickMenuB(sourceEntitya) {
    ...
    form.textField("Block Dimension", "Block Dimension", { defaultValue: String(sourceEntity.dimension.id) });
...
//# sourceMappingURL=editorStickMenuB.js.map