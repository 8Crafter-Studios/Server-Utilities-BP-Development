...
/**
 * Displays and handles the advanced chat style settings form for a given player or entity.
 *
 * @async
 ...
 */
export async function chatRanksSettings_chatStyleSettings(sourceEntity) {
    ...
    try {
        ...
        const includedOptions = cullUndefined([
            ...
            ...(rankMode === "custom_simple"
                ? [
                    ...
                    /* "rankEvaluatorMode_nameTags", */ "rankDisplayPrefix",
                    "rankDisplaySuffix",
                    "nameDisplayPrefix",
                    "nameDisplaySuffix",
            ...
            ["style_2", "style_3", "style_4"].includes(rankMode) ? "defaultSeparatorFormatting" : undefined,
        ...
        form.title(customFormUICodes.modal.titles.formStyles.medium + "Chat Style Settings");
...
//# sourceMappingURL=chatRanksSettings_chatStyleSettings.js.map