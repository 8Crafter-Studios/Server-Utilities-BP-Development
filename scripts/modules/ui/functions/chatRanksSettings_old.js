 ...
 */
export async function chatRanksSettings_old(sourceEntity) {
    ...
    try {
        ...
        const formOptionsMap = {
            ...
            showRanksOnPlayerNameTags: () => form.toggle("§l§fShow Ranks On Player Name Tags§r§f\nSets whether or not to show player's ranks on their name tag, default is false", { defaultValue: config.chatRanks.showRanksOnPlayerNameTags }),
        };
...
//# sourceMappingURL=chatRanksSettings_old.js.map