            ...
            default:
                ...
                return await forceShow(form4, sourceEntity)
                    ...
                    if (h.selection == 0) {
                        ...
                        const r = await showMessage(sourceEntity, "Are you sure?", `Are you sure you want to unban ${ba.playerName ?? ba.originalPlayerName}<${ba.playerId ?? ba.originalPlayerId}>?`, "Unban", "Cancel");
