...
export async function playerMenu_bounty_new(sourceEntitya, pagen = 0, maxplayersperpage = config.ui.pages
    ...
    return await forceShow(form, sourceEntity)
            ...
            case "search":
                {
                    ...
                    if (!!!rb || rb?.canceled == true) {
                        return await playerMenu_bounty_new(sourceEntity, page, maxplayersperpage, search);
                    }
        ...
        return await showMessage(sourceEntity as Player, undefined, "§cSorry, the search feature has not been implemented yet.", "Back", "Close").then(async r=>{
            if(r.selection==0){
                ...
                break;
            case "previous":
                return await playerMenu_bounty_new(sourceEntity, Math.max(0, page - 1), maxplayersperpage, search);
                break;
            case "next":
