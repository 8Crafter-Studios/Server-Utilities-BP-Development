...
export async function nameTagsSettings_generalNameTagsSettings(sourceEntity) {
    ...
    try {
        ...
        const formOptionsMap = {
            ...
            playerNameTagHealthPrecision: () => form.slider("§l§fPlayer Name Tag Health Precision§r§f\nThe maximum number of decimal places to display on the health display on player name tags. Must be between 0 and 20 (inclusive), default is 1", 0, 20, { valueStep: 1, defaultValue: config.chatRanks.playerNameTagHealthPrecision }),
        };
