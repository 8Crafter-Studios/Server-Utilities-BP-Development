 ...
 */
export async function uiSettings_main(sourceEntity) {
    ...
    try {
        ...
        form.textField("§l§fmaxPlayersPerManagePlayersPage§r§f\nThe maximum number of players to display at once on the manage players menu, the default is 9", "integer from 1-1000", { defaultValue: String(config.ui.pages.maxPlayersPerManagePlayersPage) });
        form.toggle("§l§fuseStarWarsReference404Page§r§f\nWhether or not to use the Star Wars reference version of the 404 page, the default is false", { defaultValue: config.ui.other.useStarWarsReference404Page });
    ...
    GameTest.Test.prototype.spawnSimulatedPlayer({x: 0, y: 0, z: 0})*/ /*
        ...
        let [maxPlayersPerManagePlayersPage, useStarWarsReference404Page] = r.formValues;
