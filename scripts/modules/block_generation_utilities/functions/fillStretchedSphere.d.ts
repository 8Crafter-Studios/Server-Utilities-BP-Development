 ...
 */
export declare function fillStretchedSphere<LiteModeEnabled extends boolean = false>(center: Vector3, radius: number, stretch: Vector3, dimension: Dimension, block: (location: DimensionLocation, index: bigint) => BlockPermutation, options?: {
    blockMask: BlockMask;
