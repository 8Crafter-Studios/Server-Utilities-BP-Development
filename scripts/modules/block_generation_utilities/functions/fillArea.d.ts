...
/**
 * Fills the blocks in the specified area. Supports block masks.
 * @async
 ...
 * @remarks The most modern version of the rectangular prism block filling functions.
 */
export declare function fillArea<LiteModeEnabled extends boolean = false>(begin: Vector3, end: Vector3, dimension: Dimension, block: (location: DimensionLocation, index: bigint) => BlockPermutation, options?: {
    blockMask: BlockMask;
