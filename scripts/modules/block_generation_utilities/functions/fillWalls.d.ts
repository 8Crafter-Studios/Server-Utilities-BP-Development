 ...
 */
export declare function fillWalls<LiteModeEnabled extends boolean = false>(begin: Vector3, end: Vector3, dimension: Dimension, block: (location: DimensionLocation, index: bigint) => BlockPermutation, options?: {
    blockMask: BlockMask;
