...
.dupeitem - §oDuplicates the item in your hand.§r
...
.editorstick - §oOpens the Editor Stick UI.§r
.editorstickb - §oOpens the Editor Stick B UI.§r
.editorstickc - §oOpens the Editor Stick C UI.§r
...
.entityscaleversion - §oDisplays the currently detected versions of 8Crafter's Entity Scale Add-On that is active on the world.§r
...
.getworldspawnpoint - §oGets the current world spawn point.§r
...
.hcontents - §oLists the contents of all of your currently saved hotbar presets.§r
...
.invseep - §oDisplays the contents of the specified player's inventory, including the dynamic properties set on the items.§r
...
.j - §oTeleports you to the block you are looking at.§r
.jumpto - §oTeleports you to the block you are looking at.§r
...
.notificationsettings - §oOpens up the notifications settings menu.§r
...
.phase - §oTeleports you 2 blocks in the direction you are looking.§r
...
.remexpne - §oRemoves explosive blocks in the specified radius, the radius defaults to 10 if not specified. Removes TNT and respawn anchors if in the overworld, removes TNT and beds if in the nether, and removes TNT, beds, and respawn anchors if in the end. Unlike the \remexp command, this one does not remove explosive entities, it only removes explosive blocks.§r
.remexpentity - §oRemoves explosive entities in the specified radius, the radius defaults to 10 if not specified.§r
...
.replacenear - §oReplaces blocks of the specified type with another specified block type in the specified radius.§r
...
.spawn - §oTeleports you to spawn.§r
.stopalldbintervals - §oStops all known intervals from system.runInterval() for this add-on.§r
.stopallsaintervals - §oStops all known intervals from system.runInterval() for the entity scale add-on if it is active and is on version 1.14.0 or newer.§r
...
.swaprows - §oSwaps two inventory rows, if the row number is not a whole number then it will offset the row selection by that much.§r
...
.selectionrender - §oUses particles to render the outline of the selected area.§r
.selrender - §oUses particles to render the outline of the selected area.§r
.selr - §oUses particles to render the outline of the selected area.§r
.snapshot - §rManages backups and backup areas.§r
.\\savestructure - §oSaves the selected area as a structure.§r
.\\deletesavedpos - §oDeletes the saved selection with the specified ID.§r
.\\listpos - §oLists all of your saved selections.§r
.\\loadpos - §oLoads the saved selection with the specified ID into the pos1, pos2, and posD values.§r
.\\savepos - §oSaves your current selection (pos1, pos2, and posD) into a saved selection with the specified ID, that can be loaded in at any time using the \\\\loadpos command.§r
...
.\\stsphere - §oGenerates a sphere in the selected area that is stretched to fill the area. It basically generates an ovoid.§r
.\\cone - §oGenerates a cone in the selected area.§r
.\\cyl - §oGenerates a cylinder in the selected area.§r
.\\tube - §oGenerates a tube in the selected area.§r
...
//# sourceMappingURL=helpCommandChatCommandsList.js.map