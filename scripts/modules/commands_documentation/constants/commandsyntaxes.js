...
ex. ${command.dp}summon 5 sheep<spawn_baby> ~~~~~ true "Baby Sheep That Won't Despawn"`,
    ...
    "tpa": `${command.dp}tpa <player: target[allowMultiple=false,playersOnly=true]>`,
    "tpaccept": `${command.dp}tpaccept <player: target[allowMultiple=true,playersOnly=true]>`,
    "tpdeny": `${command.dp}tpdeny <player: target[allowMultiple=true,playersOnly=true]>`,
...
${command.dp}snapshot list`,
    ...
    "\\\\loadchunks": `${command.dp}\\loadchunks [-v]`,
...
//# sourceMappingURL=commandsyntaxes.js.map