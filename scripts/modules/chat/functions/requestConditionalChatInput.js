    ...
    return new Promise((resolve, reject) => {
        function a() {
            ...
            if (!!!currentlyRequestedChatInput[player.id].conditionalInput[id].input) {
                ...
                else if (options.expireConditions
                    ? currentlyRequestedChatInput[player.id].conditionalInput[id].expireConditions(currentlyRequestedChatInput[player.id].conditionalInput[id]) ?? false
                    : false) {
                    delete currentlyRequestedChatInput[player.id].conditionalInput[id];
