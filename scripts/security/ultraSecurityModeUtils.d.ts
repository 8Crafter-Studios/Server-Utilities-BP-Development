...
export declare function commandsUltraSecurityModeSecurityLevelOverridesEditor(player: Player): Promise<1 | 0 | -423 | -403>;
export declare function commandsUltraSecurityModeSecurityLevelOverridesEditor_categories(player: Player): Promise<1 | 0 | -423 | -403>;
export declare function selectCommandsUltraSecurityModeSecurityLevelOverrides_category(player: Player, category: commandCategory): Promise<1 | -423 | -403>;
export declare function commandsUltraSecurityModeSecurityLevelOverridesEditor_commands(player: Player): Promise<1 | 0 | -423 | -403>;
export declare function commandsUltraSecurityModeSecurityLevelOverridesEditor_commands_category(player: Player, category: commandCategory): Promise<1 | 0 | -423 | -403>;
export declare function selectCommandsUltraSecurityModeSecurityLevelOverrides_command_builtIn(player: Player, command: command<"built-in">): Promise<1 | -423 | -403>;
export declare function selectCommandsUltraSecurityModeSecurityLevelOverrides_command_custom(player: Player, command: command<"custom">): Promise<1 | -423 | -403>;
export declare function ultraSecurityModeDebug(player: Player): Promise<-423 | -403 | 1>;
export declare function resetPlayerPermissionsUI(player: Player): Promise<1 | -423 | -403>;
export declare function resetPlayerPermissionsForPlayerUI(player: Player, targetPlayerId: LooseAutocomplete<"everyone" | (typeof permissionPresetMap)[keyof typeof permissionPresetMap]>, isPreset?: boolean): Promise<1 | -423 | -403>;
