import { ChatSendBeforeEvent, Player, system, world, type RawMessage } from "@minecraft/server";
import { srun, config, dimensionTypeDisplayFormattingE } from "../Main";
...
import { chatCommands, cmdsEval, command } from "./commands";
