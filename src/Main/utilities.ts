...
export function splitUpStringData(data: string, chunkSize: number|bigint = 32760){
    if(chunkSize==0){
...
export function saveStringToDynamicProperties(string: string, propertyName: string, clearOldProperties: boolean = true, chunkSize: number|bigint = 32760){
...
export function getStringFromDynamicProperties(propertyName: string){
    if(typeof propertyName != "string"){
...
export function mcRGBAToColorCoreRGB(rgba: RGBA): colorCore.RGB{
    return {r: rgba.red*255, g: rgba.green*255, b: rgba.blue*255, a: rgba.alpha}
}
export function mcRGBToColorCoreRGB(rgba: RGB): colorCore.RGB{
