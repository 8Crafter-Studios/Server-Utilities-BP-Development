 ...
 */
export function extractPlayerFromLooseEntityType(looseEntityType: loosePlayerType, functionArgumentDetails: {index: number, name: string}|{customSourceMessage: string}|"none" = {index: 0, name: "sourceEntity"}): Player {
