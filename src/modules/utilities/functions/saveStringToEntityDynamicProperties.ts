 ...
 */
export function saveStringToEntityDynamicProperties(entity: Entity, string: string, propertyName: string, clearOldProperties: boolean = true, chunkSize: number | bigint = 32760): void {
