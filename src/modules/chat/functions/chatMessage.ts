...
export function chatMessage(
    ...
    if (
        ...
        currentlyRequestedChatInput[eventData.sender.id].anyInput[
            Object.keys(
                ...
                (a, b) =>
                    currentlyRequestedChatInput[eventData.sender.id].anyInput[a]
                        .time -
        ...
        world
            ...
            .forEach((p) => {
                try {
                    ...
                    srun(() =>
                        p.playSound(
                            pn.getAllChatMessagesNotificationSound.soundId,
                            {
    ...
    if (
        ...
        if (newMessage.includes("${eu}")) {
            ...
            newMessage = newMessage.escapeCharacters(
                false,
                true,
                0,
                false,
    ...
    if (
        ...
        if (
            ...
            if (
                ...
                player.hasTag("canUseChatCommands") &&
                (world.getDynamicProperty(
                    "andexdbSettings:sendMessageOnInvalidChatCommand"
                ) ?? false) == false
            ) {
            } else {
                chatSend({
