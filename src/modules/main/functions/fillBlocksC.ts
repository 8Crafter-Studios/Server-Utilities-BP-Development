import { type Vector3, Dimension, BlockVolume, BlockTypes, BlockPermutation } from "@minecraft/server";

/**
 * @deprecated
 */
export function fillBlocksC(
    begin: Vector3,
    end: Vector3,
    dimension: Dimension,
    blocktype: string = "air",
