 ...
 */
export function getCommandHelpPageCustomDebug(commandName: string, player?: loosePlayerType, spacing: number = 0): string {
    /**
     * The matched command.
     *
    ...
    let cmd:
        ...
        | command<"custom"> =
        CommandRegistry.getCommand(commandName, { typeFilter: "custom", includeAliases: true }) ??
        command.get(
