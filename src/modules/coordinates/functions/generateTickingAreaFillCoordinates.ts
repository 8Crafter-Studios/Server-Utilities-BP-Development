import { Dimension, type DimensionLocation, BlockVolume } from "@minecraft/server";
import type { CompoundBlockVolume } from "CompoundBlockVolumePolyfill";

export function generateTickingAreaFillCoordinates(area: CompoundBlockVolume, dimension: Dimension): DimensionLocation[] {
