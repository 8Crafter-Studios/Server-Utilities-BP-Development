...
import type { FilterKey, ReplaceTypeOfKey } from "modules/utilities/functions/filterProperties";
 ...
 */
export interface playerMenuLeaderboardStatistic<
...
export type playerMenuLeaderboardStatistic_JSONB<
    T extends "built-in" | "custom" | "customAdvanced",
    SortType extends T extends "customAdvanced" ? "function" | "order" : never = T extends "customAdvanced" ? "function" | "order" : never
> = T extends "built-in" | "customAdvanced" ? ReplaceTypeOfKey<
    ReplaceTypeOfKey<playerMenuLeaderboardStatistic<T>, ["valueDisplayTransformer_button", "valueDisplayTransformer_statsList", T extends "built-in" | "customAdvanced" ? "getterFunction" : never], string>,
    "sorter",
    T extends "built-in" ? string : SortType extends "function" ? string : ObjectiveSortOrder
> : ReplaceTypeOfKey<playerMenuLeaderboardStatistic<T>, ["valueDisplayTransformer_button", "valueDisplayTransformer_statsList", T extends "built-in" | "customAdvanced" ? "getterFunction" : never], string>;
