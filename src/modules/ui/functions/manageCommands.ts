    ...
    if (securityVariables.ultraSecurityModeEnabled) {
        if (securityVariables.testPlayerForPermission(sourceEntity as Player, "andexdb.accessManageCommandsUI") == false) {
            const r = await showMessage(
                ...
                "Access Denied (403)",
                "You do not have permission to access this menu. You need the following permission to access this menu: andexdb.accessManageCommandsUI",
                "Back",
                "Cancel"
            );
            ...
            switch (r.selection) {
                ...
                default: {
                    ...
                    commandsListB.forEach((p) => {
                        form.button(
                            `${customFormUICodes.action.buttons.positions.main_only}${p.formatting_code + p.commandName}\n${
                                p.type + ": " + (p.settings.enabled ? "enabled" : "disabled") + "; " + p.command_version
                            }` /*, "textures/ui/online"*/
                        );
                    });
                                    ...
                                    forceShow(form5, sourceEntity as Player)
                                        .then((ha) => {
                                            ...
                                            if (!!!h.formValues![0]) {
                                                ...
                                                forceShow(formErrora, sourceEntity as Player).then(() => {
                                                    manageCommands(sourceEntity);
                                                    return;
                                                });
                                                return;
                                ...
                                default:
                                    ...
                                    form2.body(
                                        `Command Name: ${commandsItem.commandName}\nType: ${commandsItem.type}\nCommand Version: ${
                                            ...
                                            typeof commandsItem.category == "string" ? "y" : "ies"
                                        }: ${JSONStringify(commandsItem.category)}\n\nDescription: ${commandsItem.description}\nFormats: ${JSONStringify(
                                        ...
                                        .then((ga) => {
                                            ...
                                            switch (g.selection! + Number(commandsItem.type != "custom") * 3) {
                                                case 0:
                                                    ...
                                                    forceShow(form3, sourceEntity as Player)
                                                        .then((ha) => {
                                                ...
                                                case 1:
                                                    ...
                                                    form5.dropdown(
                                                        "Command Code Type (commands means the command just runs a list of minecraft commands, and javascript means that the command runs a list of javascript scripts/code)",
                                                        ["commands", "javascript"],
                                                        { defaultValueIndex: ["commands", "javascript"].findIndex((v) => v == commandsItem.customCommandType) }
                                                    );
                                                    ...
                                                    form5.textField(
                                                        ...
                                                        "JSON",
                                                        { defaultValue: JSONStringify(commandsItem.customCommandParametersList ?? ["presetText"]) }
                                                    );
                                                    ...
                                                    forceShow(form5, sourceEntity as Player)
                                                        .then((ha) => {
                                                            ...
                                                            if (
                                                                ...
                                                                forceShow(formError, sourceEntity as Player).then((sa) => {
                                                                    console.warn((sa as MessageFormResponse).selection);
                                                ...
                                                case 2:
                                                    ...
                                                    if (
                                                        commandsItem.customCommandCodeLines == 1 ||
                                                        ...
                                                        form7.textField(
                                                            ...
                                                            commandsItem.customCommandType == "commands" ? "Minecraft Command" : "JavaScript Code",
                                                            { defaultValue: commandsItem.code[0] }
                                                        );
                                                    } else {
                                                            ...
                                                            form7.textField(
                                                                "Line " +
                                                                    ...
                                                                    (i == 0
                                                                        ...
                                                                        : ""),
                                                                commandsItem.customCommandType == "commands" ? "Minecraft Command" : "JavaScript Code",
                                                                { defaultValue: commandsItem.code[i] }
                                                            );
                                                        }
                                                    }
                                                    form7.submitButton("Save");
                                                    forceShow(form7, sourceEntity as Player)
                                                        .then((ha) => {
                                                            let h = ha as ModalFormResponse;
                                                            if (h.canceled) {
                                                                manageCommands(sourceEntity);
                                                            ...
                                                            world
                                                                ...
                                                                .filter(
                                                                    (v) =>
                                                                        v.startsWith("customCommandCode:" + commandsItem.commandName + ":") &&
                                                ...
                                                case 3:
                                                    ...
                                                    form4.body(
                                                        `§r§f${
                                                            /*arrayModifier(*/ JSON.stringify(commandsItem).replaceAll(
                                                                /(?<!\\)(?![},:](\"|{\"))\"/g,
                                                                '§r§f"'
