...
export async function personalSettings(sourceEntitya: Entity | executeCommandPlayerW | Player): Promise<-2 | 0 | 1> {
    ...
    if (securityVariables.ultraSecurityModeEnabled) {
        if (securityVariables.testPlayerForPermission(sourceEntity as Player, "andexdb.accessPersonalSettings") == false) {
            const r = await showMessage(
                ...
                "Access Denied (403)",
                "You do not have permission to access this menu. You need the following permission to access this menu: andexdb.accessPersonalSettings",
                "Back",
                "Cancel"
            );
    ...
    form.toggle(
        ...
        { defaultValue: sourceEntity.hasTag("doNotSetNameTag") }
    );
    form.textField(
    ...
    GameTest.Test.prototype.spawnSimulatedPlayer({x: 0, y: 0, z: 0})*/ /*
        ${se}GameTest.Test.prototype.spawnSimulatedPlayer({x: 0, y: 0, z: 0})*/
            ...
            sourceEntity.setDynamicProperty(
                ...
                chatNameAndMessageSeparator == "" ? undefined : chatNameAndMessageSeparator
            );
