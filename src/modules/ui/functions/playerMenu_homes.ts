...
export async function playerMenu_homes(sourceEntitya: Entity | executeCommandPlayerW | Player): Promise<0 | 1> {
    ...
    const canBypassTeleportCooldowns =
                ...
                case "home":
                    ...
                    switch (
                        ...
                        case "teleport":
                            ...
                            if (
                                Number(sourceEntity.getDynamicProperty("lastTeleportTime") ?? 0) + config.teleportSystems.teleportCooldown * 1000 >
                                Date.now()
                            ) {
                                sourceEntity.sendMessage(
