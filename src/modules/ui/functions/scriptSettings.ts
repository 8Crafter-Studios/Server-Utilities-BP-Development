...
export async function scriptSettings(
    ...
    form.textField(
        ...
        "integer",
        { defaultValue: String(config.system.defaultMinMSBetweenTickWaits) }
    );
    form.dropdown(
        ...
        ["Memory", "World"],
        { defaultValueIndex: ["Memory", "World"].indexOf(String(config.undoClipboardMode)) }
    );
    form.divider();
    ...
    form.textField(
        ...
        "integer from 1-1000",
        { defaultValue: String(config.system.playerDataRefreshRate) }
    );
    form.textField(
        ...
        { defaultValue: String(config.system.bannedPlayersRefreshRate) }
    );/* 
    form2.textField(
    ...
    form.toggle(
        ...
        { defaultValue: config.system.protectedAreasZoneActionsEnabled }
    );
    form.textField(
        ...
        "integer from 1-1000000",
        { defaultValue: String(config.system.protectedAreasZoneActionsInterval) }
    );
    form.textField(
        ...
        "integer from 1-1000000",
        { defaultValue: String(config.system.protectedAreasZoneRefreshInterval) }
    );
    form.divider();
    ...
    form.toggle(
        ...
        { defaultValue: config.system.showEntityScaleNotFoundConsoleLog }
    );
    form.toggle(
        ...
        { defaultValue: config.system.showEntityScaleFoundConsoleLog }
    );
    form.toggle(
        ...
        { defaultValue: config.system.showEntityScaleNotFoundChatLog }
    );
    form.toggle(
        ...
        { defaultValue: config.system.showEntityScaleFoundChatLog }
    );
    form.toggle(
        ...
        { defaultValue: config.system.showBlueModsAnticheatNotFoundConsoleLog }
    );
    form.toggle(
        ...
        { defaultValue: config.system.showBlueModsAnticheatFoundConsoleLog }
    );
    form.toggle(
        ...
        { defaultValue: config.system.showBlueModsAnticheatNotFoundChatLog }
    );
    form.toggle(
        ...
        { defaultValue: config.system.showBlueModsAnticheatFoundChatLog }
    );
    form.divider();
    form.header("Debugging");
    form.toggle(
        "§l§fdebugMode§r\nWhether debug mode is enabled or not, the default is false",
        { defaultValue: config.system.debugMode }
    );
    if (config.system.debugMode) {
        form.textField(
            ...
            "int",
            { defaultValue: String(config.system.artificialLagMS) }
        );
        form.toggle(
            ...
            { defaultValue: config.system.allowWatchdogTerminationCrash }
        );
        form.toggle(
            ...
            { defaultValue: config.system.hideWatchdogTerminationCrashEnabledWarningsOnStartup }
        );
        form.toggle(
            ...
            { defaultValue: config.system.spreadPlayerInventoryDataSavesOverMultipleTicks }
        );
    }
