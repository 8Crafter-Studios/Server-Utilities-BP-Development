 ...
 */
export async function nameTagsSettings_previewNameTag(sourceEntity: loosePlayerType): Promise<0 | 1> {
        ...
        form.body(
            `§r${rankNameTagEvaluator(
                { hidden: false, sourceType: "name", value: "Steve 1238" },
                {
                    ...
                    ...rankNameTagEvaluator_getChatMessageFormatFromPlayerTags(
                        rankNameTagEvaluator_generatePartialPlayerTypeForRankNameTagEvaluatorEvaluationFunctions({
                            tags: ["rank:§bRank", "rank:§cOther Rank"],
                            nameTag: "Steve 1238",
                            name: "Steve 1238",
                        })
