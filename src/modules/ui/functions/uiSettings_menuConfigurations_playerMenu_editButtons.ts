...
export async function uiSettings_menuConfigurations_playerMenu_editButtons(sourceEntity: loosePlayerType): Promise<0 | 1> {
...
Default Button Index: ${button.defaultButtonIndex}${button.deprecated ? "\n§pThis button is deprecated.§r" : ""}${
                        ...
                        .forceShow(player);
                    if (rb.canceled || rb.selection === 2) continue;
