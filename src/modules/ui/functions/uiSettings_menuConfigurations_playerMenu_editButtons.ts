...
export async function uiSettings_menuConfigurations_playerMenu_editButtons(sourceEntitya: Entity | executeCommandPlayerW | Player): Promise<0 | 1> {
...
Default Button Index: ${button.defaultButtonIndex}${button.deprecated ? "\n§pThis button is deprecated.§r" : ""}${
                    ...
                    if(rb.canceled || rb.selection === 2) return await uiSettings_menuConfigurations_playerMenu_editButtons(sourceEntity);
