 ...
 * ```
 */
declare module "@minecraft/server-editor-private-bindings" {
    ...
    export class InputService {
         ...
         * @throws This function can throw errors.
         */
        registerMouseBinding(contextId: string, bindingId: string, mouseAction: minecraftservereditorbindings.MouseActionCategory): void;
        /**
         * @remarks This function can't be called in read-only mode.
         *
         * @throws This function can throw errors.
    ...
    export class JigsawService {
         ...
         * @throws This function can throw errors.
         */
        generateJigsaw(registryName: string, startingPool: string, seed: minecraftserverbindings.Vector3, depth: number): Promise<EditorJigsawSection[]>;
        /**
         * @remarks This function can't be called in read-only mode.
         */
    ...
    export class RealmsService {
         ...
         * @throws This function can throw errors.
         */
        beginUploadToRealms(realmsWorldId: string, slotId: number, gameOptions: minecraftservereditorbindings.GameOptions): Promise<RealmsWorldUploadResult>;
        /**
         * @remarks This function can't be called in read-only mode.
         */
