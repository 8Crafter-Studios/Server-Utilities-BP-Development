    ...
    if (id == "andexdb:cmd") {
        chatCommands({
            ...
            event: {
                cancel: false,
                message: message.replaceAll("\\@\\", "@").replaceAll("\\>\\", ">").replaceAll("\\<\\", "<"),
                sender: (initiator ?? sourceEntity ?? sourceBlock) as Player,
            },
            eventData: {
                cancel: false,
                message: message.replaceAll("\\@\\", "@").replaceAll("\\>\\", ">").replaceAll("\\<\\", "<"),
            ...
            player: new executeCommandPlayerW(
                new WorldPosition(
                    tryget(() => ((initiator ?? sourceEntity ?? sourceBlock) as Player).location) ?? { x: 0, y: 0, z: 0 },
                    tryget(() => ((initiator ?? sourceEntity) as Player).getRotation()) ?? { x: 0, y: 0 },
                    tryget(() => ((initiator ?? sourceEntity ?? sourceBlock) as Player).dimension) ?? overworld,
...
break;*/ /*
    ...
    form.textField("Item Data", "Trigger Event", {defaultValue: ""});*/
                ...
                form.dropdown(
                    ...
                    ["Player", "§4Facing Entity", "§4Entity At Block Location", "§4Facing Block", "Block At Block Location"],
                    { defaultValueIndex: 0 }
                );
    ...
    if (id == "andexdb:inventoryTransfer") {
        ...
        form.show(players[players.findIndex((x) => x == sourceEntity)] as any)
            .then((r) => {
                // This will stop the code when the player closes the form
                if (r.canceled) return;
                                        ...
                                        form3
                                            ...
                                            .then((t) => {
                                                ...
                                                if (Number(fromBlockSelectionMode) > 0) {
                                                    ...
                                                    try {
                                                        fromPresetValues = callerPlayer.getDynamicProperty(
                                                            "blockTransferPreset" + String(Number(fromBlockSelectionMode) - 1)
                                                        );
                                                    } catch (e) {
                                                        console.error(e, e.stack);
                                                    }
                                                ...
                                                if (Number(toBlockSelectionMode) > 0) {
                                                    ...
                                                    try {
                                                        toPresetValues = callerPlayer.getDynamicProperty(
                                                            "blockTransferPreset" + String(Number(toBlockSelectionMode) - 1)
                                                        );
                                                    } catch (e) {
                                                        console.error(e, e.stack);
                                                    }
                    ...
                    switch (response) {
                        ...
                        case 1:
                            ...
                            break;*/:
                                        ...
                                        form4.dropdown(
                                            "Transfer Type",
                                            ["Swap", "Transfer To Block", "Transfer To Player", "Move To Block", "Move To Player"],
                                            { defaultValueIndex: 0 }
                                        );
                                        ...
                                        form4
                                            ...
                                            .then((t) => {
                                                ...
                                                if (Number(blockSelectionMode) > 0) {
                                                    ...
                                                    try {
                                                        presetValues = callerPlayer.getDynamicProperty(
                                                            "blockTransferPreset" + String(Number(blockSelectionMode) - 1)
                                                        );
                                                    } catch (e) {
                                                        console.error(e, e.stack);
                                                    }
    ...
    console.warn(item.nameTag);*/ /*
                ...
                form.textField(
                    "Item Type: " +
                        ...
                        "\nItem Name\nTo type multiple lines just put \\\\newline in between each line. \nTo clear item name just leave field blank. ",
                    "Item Name",
                    { defaultValue: itemNameTextField /*(String(item.nameTag))*/ }
                );
                form.textField("Item Lore\nTo type multiple lines just put \\\\newline in between each line. ", "Item Lore", {
                    defaultValue: itemLoreTextField,
                });
                    ...
                    switch (i % 5) {
                        case 0:
                            world.setDynamicProperty(
                                ...
                                `${customElementTypeIds[Number(elementValues[i])]}|${elementValues.slice(i + 1, i + 4).join("|")}`
                            );
                            break;
                        case 4:
                            if (Boolean(v) == true) {
    ...
    if (id == "andexdb:debugStickMenuC" || id == "andexdb:editorStickMenuC") {
        ...
        form.show(playerList[playerList.findIndex((x) => x == sourceEntity)] as any)
            .then((r) => {
                if (r.canceled) return;
    ...
    clearVelocity*/,
        ...
        console.warn(blockPropertyValueArray[index])*/
                        ...
                        if (
                            String(blockPropertyValueArray[index]).startsWith('"') == false &&
    ...
    if (id == "andexdb:entityController") {
        ...
        function playerControllerFormPopup(playerTargetB: Entity, playerTargetB2: EntityRaycastHit, playerViewerB: number) {
            let form = new ModalFormData(); /*
    ...
    if (id == "andexdb:getWorldDynamicProperty") {
        let dynamicProperty = message.split("|");
        try {
            (sourceEntity as Player).sendMessage("a" + String(world.getDynamicProperty(String(dynamicProperty[0]))));
        } catch (e) {
            console.error(e, e.stack);
        }
    }
