...
GameTest.register("VibrationTests", "detection_radius", (test) => {
  const sensorPos = new BlockLocationIterator(9, 11, 9);

  const minDestroyPos = new BlockLocationIterator(0, 2, 0);
  const maxDestroyPos = new BlockLocationIterator(18, 20, 18);
...
GameTest.register("VibrationTests", "output_distance", (test) => {
  const sensorPos = new BlockLocationIterator(16, 2, 9);

  let sequence = test.startSequence();

  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(0, 0, -8),
    sensorPos.offset(-1, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(0, 0, -7),
    sensorPos.offset(-2, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(3, 0, -6),
    sensorPos.offset(-3, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(0, 0, -6),
    sensorPos.offset(-4, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(3, 0, -5),
    sensorPos.offset(-5, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(0, 0, -5),
    sensorPos.offset(-6, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(2, 0, -4),
    sensorPos.offset(-7, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(0, 0, -4),
    sensorPos.offset(-8, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(2, 0, -3),
    sensorPos.offset(-9, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(0, 0, -3),
    sensorPos.offset(-10, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(1, 0, -2),
    sensorPos.offset(-11, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(0, 0, -2),
    sensorPos.offset(-12, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(1, 0, -1),
    sensorPos.offset(-13, -1, 1)
  );
  destroyBlockAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    sensorPos.offset(0, 0, -1),
    sensorPos.offset(-14, -1, 1)
  );
  spawnCreeperAndTestComparatorOutput(
    test,
    sequence,
    sensorPos,
    new Location(16.5, 3, 9.5),
    sensorPos.offset(-15, -1, 1)
  );
...
GameTest.register("VibrationTests", "activation_multiple_vibrations", (test) => {
  const sensorPos = new BlockLocationIterator(9, 2, 9);

  const testEx = new GameTestExtensions(test);

  const destroyPosFar = new BlockLocationIterator(9, 2, 1);
  const destroyPosClose = new BlockLocationIterator(9, 2, 10);
...
GameTest.register("VibrationTests", "activation_duration", (test) => {
  ...
  const destroyPos = new BlockLocationIterator(8, 2, 9);
...
GameTest.register("VibrationTests", "activation_cooldown", (test) => {
  ...
  const destroyPos1 = new BlockLocationIterator(8, 2, 9);
  const destroyPos2 = new BlockLocationIterator(10, 2, 9);
...
GameTest.register("VibrationTests", "activation_wool_occlusion", (test) => {
  ...
  const occuledDestroyPos1 = new BlockLocationIterator(5, 2, 9);
  const occuledDestroyPos2 = new BlockLocationIterator(9, 2, 13);
  const occuledDestroyPos3 = new BlockLocationIterator(13, 2, 9);
  const unocculedDestroyPos1 = new BlockLocationIterator(9, 2, 5);
  const unocculedDestroyPos2 = new BlockLocationIterator(9, 6, 9);
...
GameTest.register("VibrationTests", "activation_wool_occlusion_no_bias", (test) => {
  ...
  const occuledDestroyPos1 = new BlockLocationIterator(6, 2, 6);
  const occuledDestroyPos2 = new BlockLocationIterator(6, 2, 12);
  const occuledDestroyPos3 = new BlockLocationIterator(12, 2, 6);
  const occuledDestroyPos4 = new BlockLocationIterator(12, 2, 12);
...
GameTest.register("VibrationTests", "event_entity_move", (test) => {
  const sensorPos = new BlockLocationIterator(9, 2, 9);
  const comparatorPos = new BlockLocationIterator(9, 2, 10);
  ...
  const targetPos = new BlockLocationIterator(2, 2, 7);
...
GameTest.register("VibrationTests", "event_entity_move_cobweb", (test) => {
  ...
  const targetPos = new BlockLocationIterator(7, 2, 7);
  test.walkTo(pig, targetPos, 1);
...
GameTest.register("VibrationTests", "event_entity_move_sneaking", (test) => {
  ...
  const spawnPos = new BlockLocationIterator(11, 2, 7);
  const targetPos = new BlockLocationIterator(7, 2, 7);
...
GameTest.register("VibrationTests", "event_entity_move_sneaking_on_sensor", (test) => {
  const sneakOnSensorPos = new BlockLocationIterator(9, 2, 9);
  const unaffectedSensorPos = new BlockLocationIterator(9, 5, 9);

  const spawnPos = new Location(7.5, 2, 9.5);
  const targetPos = new BlockLocationIterator(11, 2, 9);
...
GameTest.register("VibrationTests", "event_flap_parrot", (test) => {
  ...
  const targetPos = new BlockLocationIterator(7, 2, 9);
...
GameTest.register("VibrationTests", "event_swim_still", (test) => {
  ...
  failOnVibrationDetected(
    test,
    sensorPos,
    TicksPerSecond * 1,
    SENSOR_MAX_DELAY_TICKS + SENSOR_ACTIVE_TICKS + SENSOR_COOLDOWN_TICKS
  );
}).tag(GameTest.Tags.suiteDefault);
...
GameTest.register("VibrationTests", "event_swim_boat", (test) => {
  ...
  const targetPos = new BlockLocationIterator(6, 3, 7);
...
GameTest.register("VibrationTests", "event_hit_ground_dampening", (test) => {
  ...
  const placeAtPos = new BlockLocationIterator(9, 6, 6);
...
GameTest.register("VibrationTests", "event_projectile_shoot", (test) => {
  const sensorPos = new BlockLocationIterator(9, 2, 9);
  const comparatorPos = new BlockLocationIterator(9, 2, 8);
  const expectedFrequency = 7;

  const placeAtPos = new BlockLocationIterator(9, 4, 4);
  test.setBlockType(MinecraftBlockTypes.redstoneBlock, placeAtPos);
...
GameTest.register("VibrationTests", "event_projectile_land_wool", (test) => {
  ...
  const placeAtPos = new BlockLocationIterator(9, 7, 4);
  test.setBlockType(MinecraftBlockTypes.redstoneBlock, placeAtPos);
...
GameTest.register("VibrationTests", "event_dispense_fail", (test) => {
  ...
  const placeAtPos = new BlockLocationIterator(9, 2, 3);
  test.setBlockType(MinecraftBlockTypes.redstoneBlock, placeAtPos);
...
GameTest.register("VibrationTests", "event_block_close", (test) => {
  ...
  const placeAtPos = new BlockLocationIterator(12, 2, 5);
...
GameTest.register("VibrationTests", "event_block_destroy", (test) => {
  ...
  const spawnPos = new BlockLocationIterator(9, 2, 6);
  const player = test.spawnSimulatedPlayer(spawnPos, "Ralph");

  const breakPos = new BlockLocationIterator(9, 2, 7);
...
GameTest.register("VibrationTests", "event_container_close", (test) => {
  ...
  const spawnPos = new BlockLocationIterator(9, 2, 5);
  const chestPos = new BlockLocationIterator(9, 2, 7);
...
GameTest.register("VibrationTests", "event_entity_place", (test) => {
  ...
  const placeAtPos = new BlockLocationIterator(9, 2, 4);
  test.setBlockType(MinecraftBlockTypes.redstoneBlock, placeAtPos);
...
GameTest.register("VibrationTests", "event_equip", (test) => {
  ...
  const placeAtToDispenseSwordPos = new BlockLocationIterator(7, 2, 6);
  const placeAtToDispenseHelmetPos = new BlockLocationIterator(11, 2, 6);
...
GameTest.register("VibrationTests", "event_explode", (test) => {
  ...
  const placeAtPos = new BlockLocationIterator(9, 3, 6);
  test.setBlockType(MinecraftBlockTypes.redstoneBlock, placeAtPos);
...
GameTest.register("VibrationTests", "event_piston_contract", (test) => {
  ...
  const placeAtPos = new BlockLocationIterator(9, 2, 5);
  test.setBlockType(MinecraftBlockTypes.air, placeAtPos);
